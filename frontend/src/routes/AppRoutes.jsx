  ...
  return (
    <Routes>
      <Route path="/" element={<MainLayout />}>
        ...
        <Route path="service/patent-search" element={<Navigate to="/services/patent-search" replace />} />
        <Route path="service/patent-drafting-filing" element={<Navigate to="/services/patent-drafting-filing" replace />} />
        <Route path="service/patent-prosecution" element={<Navigate to="/services/patent-prosecution" replace />} />
        <Route path="patent-search" element={<Navigate to="/services/patent-search" replace />} />
        <Route path="patent-drafting-filing" element={<Navigate to="/services/patent-drafting-filing" replace />} />
        <Route path="patent-prosecution" element={<Navigate to="/services/patent-prosecution" replace />} />

        <Route path="service/trademark-registration" element={<Navigate to="/services/trademark-registration" replace />} />
        <Route path="service/trademark-opposition" element={<Navigate to="/services/trademark-opposition" replace />} />
        <Route path="service/trademark-renewal" element={<Navigate to="/services/trademark-renewal" replace />} />
        <Route path="service/brand-protection" element={<Navigate to="/services/brand-protection" replace />} />
        <Route path="trademark-registration" element={<Navigate to="/services/trademark-registration" replace />} />
        <Route path="trademark-opposition" element={<Navigate to="/services/trademark-opposition" replace />} />
        <Route path="trademark-renewal" element={<Navigate to="/services/trademark-renewal" replace />} />
        <Route path="brand-protection" element={<Navigate to="/services/brand-protection" replace />} />

        <Route path="service/copyright-registration" element={<Navigate to="/services/copyright-registration" replace />} />
        <Route path="service/industrial-design" element={<Navigate to="/services/industrial-design" replace />} />
        <Route path="service/design-vs-patent" element={<Navigate to="/services/design-vs-patent" replace />} />

        <Route path="service/ip-portfolio-management" element={<Navigate to="/services/ip-portfolio-management" replace />} />
        <Route path="service/ip-valuation" element={<Navigate to="/services/ip-valuation" replace />} />
        <Route path="service/startup-ip" element={<Navigate to="/services/startup-ip" replace />} />
        <Route path="service/ip-litigation-support" element={<Navigate to="/services/ip-litigation-support" replace />} />

        <Route path="service/ui-ux-design" element={<Navigate to="/services/ui-ux-design" replace />} />
        <Route path="web_services" element={<Navigate to="/services/web-development" replace />} />
