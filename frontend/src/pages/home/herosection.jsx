...
// // Real IPC (International Patent Classification) codes spanning energy,
// // electronics and software — the ambient "wallpaper" of a patent office.
// const IPC_CODES = [
//   "F03D 9/25 — Wind turbines",
//   "H01L 31/042 — Solar cells",
//   "H02J 3/38 — Grid integration",
//   "G06F 21/64 — Data integrity",
//   "H01M 10/0525 — Li-ion cells",
//   "C25B 1/04 — Hydrogen production",
//   "F24S 20/20 — Solar collectors",
//   "H02S 40/38 — PV mounting",
// ];
...
//               <span className="italic text-[#d6a52a]">strategy,<br></br>legal </span>{" "}
//               &amp; excellence.
//             </h1>
// {/* 
...
//             </p> */}
// {/* <p
//   className="mt-5 max-w-xl text-sm md:text-base leading-relaxed text-gray-200 drop-shadow-md"
// >
...
//              */}
//              {/* <p
//   className="mt-5 max-w-xl text-sm md:text-base leading-7 text-gray-100 drop-shadow-lg"
// >
//   Perceptive Brains IP is a trusted intellectual property law firm,
//   delivering trusted intellectual property solutions in patents,
//   trademarks, designs, copyrights, and IP strategy to empower
...
//           {/* Right column — application form (replaces the certificate/stats board) */}
//           <div className="flex justify-center lg:justify-end">
//             <div className="relative w-full max-w-sm">
//               {/* Seal badge, overlapping the top-right corner of the form */}
